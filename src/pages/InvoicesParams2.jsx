        ...
        <>
            <div className="page">
                ...
                <p className="page-navigations mb-0">
                    ...
                    <span className="current-path"><span style={{ textTransform: 'capitalize' }}></span> Generate</span>
                </p>
            </div>
            ...
            <div className="container-fluid px-3 pb-2">
                <form onSubmit={(e) => handleSubmit(e)}>
                    <div className="public-container px-3 py-4">
                        <h3 className="title-2 text-center mt-2 mb-3">Generate {action === 'single' ? 'A Single' : 'Bulk'} Invoice</h3>
